    ...
    public DiffSwerveModule(ModuleID id){
        ...
        switch (_modID) {
            case FrontRight:
                ...
                _swerveModuleModel= createDifferentialSwerveModule(DCMotor.getFalcon500(2),Constants.DifferentialSwerveModule.FrontRight.INERTIA_STEER,Constants.DifferentialSwerveModule.FrontRight.INERTIA_WHEEL,
            ...
            case FrontLeft:
                ...
                _swerveModuleModel = createDifferentialSwerveModule(DCMotor.getFalcon500(2),Constants.DifferentialSwerveModule.FrontLeft.INERTIA_STEER,Constants.DifferentialSwerveModule.FrontLeft.INERTIA_WHEEL,
                        Constants.DifferentialSwerveModule.GEAR_RATIO_STEER, Constants.DifferentialSwerveModule.GEAR_RATIO_WHEEL
                );
                _swerveObserver = new KalmanFilter<>(Nat.N3(), Nat.N2(), _swerveModuleModel,
                        Matrix.mat(Nat.N3(),Nat.N1()).fill(Units.degreesToRadians(2),Units.rotationsPerMinuteToRadiansPerSecond(50),Units.rotationsPerMinuteToRadiansPerSecond(50)),
